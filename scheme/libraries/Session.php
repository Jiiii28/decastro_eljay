...
class Session {
    ...
    public function __construct()
    {
        ...
        if (isset($this->config['cookie_expiration'])) {
            ...
            $this->config['cookie_expiration'] = (!isset($this->config['sess_expiration'])
                && $this->config['sess_expire_on_close'])
                ? 0
        ...
        // Regenerate session on interval
    ...
    {
        if (isset($key)) {
            return (isset($_SESSION['__lava_vars'], $_SESSION['__lava_vars'][$key], $_SESSION[$key])
                && !is_int($_SESSION['__lava_vars'][$key]))
                ? $_SESSION[$key]
                : NULL;
        }
        $flashdata = array();
